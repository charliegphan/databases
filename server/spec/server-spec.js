...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should insert posted messages to the DB', function(done) {
    ...
    request({
      ...
      request({
        ...
        var queryString = 'SELECT * FROM messages WHERE userId = 1';
        ...
        dbConnection.query(queryString, function(err, results) {
          ...
          expect(results[0].tweet).to.equal('In mercys name, three days is all I need.');
  ...
  it('Should output all messages from the DB', function(done) {
    ...
    var q = `INSERT INTO messages 
            ...
            VALUES  
            ('1', 'Men like you can never change!', 'main')`;
    ...
    dbConnection.query(q, queryArgs, function(err) {
      if (err) { throw err; }
